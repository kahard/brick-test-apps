...
env.BuildSources(
    ...
    str(brick_root / "platforms" / "esp32" / "src"),
    "+<CydSdSpiFileSystem.cpp>+<CydSpi3PinMux.cpp>+<CydTouchscreen.cpp>+<EspIdfLogger.cpp>+<File.cpp>+<FreeRtosTime.cpp>+<Ili9341SpiDisplay.cpp>+<PartitionAssetSource.cpp>+<SdSpiFileSystem.cpp>+<Xpt2046Touchscreen.cpp>",
)
