...
# ESP-12F ST7789 asset streaming benchmark
...
display in configurable stripes. The runtime buffer size depends on the
selected stripe height; there is no full-screen framebuffer in RAM.

Available variants:

- `esp12f_st7789_asset_stream_benchmark_10` — 4,800-byte stripe
- `esp12f_st7789_asset_stream_benchmark_20` — 9,600-byte stripe
- `esp12f_st7789_asset_stream_benchmark_40` — 19,200-byte stripe
